...
<div class="content">
        <div class="container">
           <form id="new_post" action="{{ route('products.store') }}" method="POST" class="form-style my_account create-raffle" name="new_post" enctype="multipart/form-data">
                        @csrf
                        <div class="title_section">
                        <label for="title">Title</label>
                        <input type="text" id="title" value="{{old('product_name')}}" tabindex="1" size="20" name="product_name">
                        </div>

                        <div class="description_section">
                        <label for="description">Description</label>
                        <textarea id="description" tabindex="3" name="description" cols="50" rows="6" placeholder="Start your description with the word “Win”, followed by a complete description of your prize." spellcheck="false">{{old('description')}}</textarea>
                        </div>
                       
                       <div class="images_section">
					<div class="inner-label"><label for="">Image</label></div>
                    ...
                    <input type="hidden" id="my_image_upload_nonce" name="my_image_upload_nonce" ><input type="hidden" name="_wp_http_referer" value="/kv1/create-a-raffle/">					</div>
                        ...
                        <div class="btn-group mr-2" role="group" aria-label="First group">
                            <span id="btn-minus" class="myBtn"><i class="fa fa-minus"></i></span>
                                                <div class="price-btn-ticket">
                                                    ...
                                                    <input type="number" value="1" name="price" min="1" max="10">
                                                </div>
                        ...
                        <input type="number" id="in_stock_tickets" value="" name="quantity" min="50" max="" placeholder="Minimum 50 tickets">
                       ...
                       <div class="datefield">
                        ...
                        <button type="submit" class="submit" value="Submit">Publish</button></form> </div>
    </div>
@endsection
